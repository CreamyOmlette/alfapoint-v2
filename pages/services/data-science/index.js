            ...
            <section className="px-[25px] py-[50px] md:px-[50px] text-black">
              ...
              <ul className="flex flex-col gap-[15px] leading-[39px] pb-[50px]">
                <li className="pl-[50px] bg-[url('/services/data-science/🧨.svg')] bg-no-repeat bg-left bg-center">
                  We develop a comprehensive strategy that encompasses the
                  entire data analytics process, including data collection,
                ...
                <li className="pl-[50px] bg-[url('/services/data-science/💗.svg')] bg-no-repeat bg-left bg-center">
                  Projects are approached with an iterative process, where
                  results are constantly evaluated and refined.
                </li>
              </ul>
